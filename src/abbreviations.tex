...
\begin{acronym}
  ...
  \acro{DEM}[DEM]{Digital Evaluation Model}
  \acro{AI}[AI]{Artifical Intelligence}
  \acro{LLM}[LLM]{Large Language Model} 
  \acro{VLM}[VLM]{Vision--Language Model}
  \acro{GAN}[GAN]{Generative Adversarial Network}
  \acro{CGAN}[CGAN]{Conditional Generative Adversarial Networks}
  \acro{BEV}[BEV]{Bird's-Eye View}
  \acro{EDT}[EDT]{Euclidean Distance Transform}
  \acro{SDF}[SDF]{Signed Distance Field}
  \acro{PCG}[PCG]{Procedural Content Generation Framework}
  \acro{ESDF}[ESDF]{Euclidean Signed Distance Field}
\end{acronym}
