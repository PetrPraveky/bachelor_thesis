...
\subsection{Euclidean Distance Transform and Signed Distance Field}
...
% todo maybe change this? Něco jako "we gave user the option to change..."
...
% todo popsat visited map a jaký je cíl?
% todo zjednodušit ty tracing části? asi s pomocí chata idk
