...
Four generated worlds were used to create datasets using Flight Forge simulator. These datasets were then evaluated using four mapping frameworks accordingly to thesis assignment. Tested mapping frameworks were: LOSOS, OctoMap, WaveMap and RayFronts. Evaluated metrics were: insertion time of a dataset point cloud, memory consumption and CPU usage. The obtained results show how datasets created from the generated environments behave in different mapping frameworks and provide a basis for comparing their performance under the tested conditions. ??? 
