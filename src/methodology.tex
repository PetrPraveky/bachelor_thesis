...
\begin{figure}[htbp]
	...
	\caption{Visual unsigned distance field of a binary mask.}
	\label{fig:edf}
\end{figure}
...
Signed distance field, shown on figure~\ref{fig:sdf}, has the same dimensions as the initial binary mask. The SDF value $v$ at pixel $p$ is defined as the sum of these two distance transforms
\begin{equation}
...
\begin{figure}[htbp]
	...
	\caption{Visual Signed distance field of a binary mask.}
	\label{fig:sdf}
\end{figure}
