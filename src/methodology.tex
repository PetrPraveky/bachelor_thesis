...
\begin{figure}[htbp]
	...
	\subfloat[Skeletonization performed on binary mask] {
		\includegraphics[width=0.48\textwidth]{./fig/generated/skeleton_branches/binarymask_skeleton_branches_1.png}
		\label{fig:skeleton_branches_1}
	}
	\subfloat[Skeletonization performed on smoothed binary mask] {
		\includegraphics[width=0.48\textwidth]{./fig/generated/skeleton_branches/binarymask_skeleton_branches_2.png}
